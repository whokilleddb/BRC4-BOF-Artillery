...
void coffee(char** argv, int argc, WCHAR** dispatch) {
    ...
    if (argc < 1) {
        ...
        "  - changepw /ticket:BASE64 /new:PASSWORD [/dc:DC] [/targetuser:USER] [/targetdomain:DOMAIN]\n"
        );
        return;
    }
    // CHAR* param = "/ticket:BASE64 /new:admin@1234 /domain:darkvortex.corp /targetuser:administrator";
